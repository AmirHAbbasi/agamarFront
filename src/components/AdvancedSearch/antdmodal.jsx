  ...
  modal_footer = () => {
    ...
    return <div dir="rtl" style={{textAlign:"left"}}>
              ...
              <button disabled={this.errorchecker()}
               onClick={this.handleOk} lang="fa" className="btn advanced-search-btn my-2 my-sm-0 ml-1 mt-1 pl-5 pr-5 pb-1 pt-1" >جستجو</button>
            </div>
  }
  ...
  render() {
    return (
      ...
      <div style={{textAlign: 'center'}} className="textfieldclass">
        ...
        }  onSearch={this.showResults}
        serverAddress={this.props.serverAddress}  lang="fa"  onChange={(e)=>{this.setState({searchvalue:e})}}   aria-label="Search"/>
        ...
        <button onClick={this.showModal} className="advanced-search-btn" >جستجوی پیشرفته</button>
      ...
      <Modal 
        ...
        <Modal 
          ...
          footer={<div style={{textAlign:"center"}}><btn className="advanced-search-btn pt-1 pb-1" onClick={() => {this.setState({categ_visible:false})}}>تائید</btn></div>}
          destroyOnClose={false}
