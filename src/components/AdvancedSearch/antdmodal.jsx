  ...
  modal_footer = () => {
    ...
    return <div dir="rtl" style={{ textAlign: "left" }}>
      ...
      <button disabled={this.errorchecker()}
        onClick={this.handleOk} lang="fa" className="btn advanced-search-btn my-2 my-sm-0 ml-1 mt-1" style={{ borderRadius: "5px" }}>تائید</button>
    </div>
  }
      ...
      <>
        ...
        >
          ...
          <div className="advancedsearchmodal">
            ...
            <button style={{ borderRadius: "5px" }} lang="fa" disabled={!this.state.categories.length} onClick={() => { this.setState({ categ_visible: true }) }} className="btn advanced-search-btn my-2 my-sm-0 ml-1 mt-1" >انتخاب دسته بندی</button>
        ...
        <div className="mt-1" style={{ textAlign: 'center' }}>
          ...
          <br /><br />
          <button style={{ borderRadius: "5px" }} onClick={this.showModal} className="advanced-search-btn my-2 my-sm-0 ml-1 mt-1" >جستجوی پیشرفته</button>

          <button style={{ borderRadius: "5px" }} lang="fa" disabled={!this.state.searchvalue} onClick={this.showResults} className="advanced-search-btn my-2 my-sm-0 ml-1 mt-1" >جستجو</button>
