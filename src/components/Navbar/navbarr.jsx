    ...
    */
    ...
    getNavBar = () => {
      if(this.state.guest){
        ...
        return <Button   variant="outline-warning">ثبت آگهی</Button>
      }
    } 
    ...
    <Navbar.Collapse id="navbarScroll">
      ...
      >
        ...
        <NavDropdown  className="NavDropdownProf" title={
          ...
          <NavDropdown.Divider />
          <NavDropdown.Item  className="navdropdown" href="/api/logout">
          <a>خروج</a>
          </NavDropdown.Item>
      ...
      <Nav style={{ marginLeft: "auto" }} dir="rtl">
         ...
         <button class="btn btn-outline-success my-2 my-sm-0 ml-1" href="/advancedsearch" type="submit">جستجوی پیشرفته</button>
      </Nav>
