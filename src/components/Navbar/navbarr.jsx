...
class Navbarr extends React.Component {
    ...
    */
    ...
    render() { 
        return (
  <Navbar value="امیرحسین عباسی" id="n0" onChange={() => this.setusername({usr:this.props.value})} fixed="top" bg="light" expand="lg" dir="ltr">
  <Container fluid>
    ...
    <Navbar.Collapse id="navbarScroll">
      ...
      >
        ...
        <NavDropdown  className="NavDropdownProf" title={
          ...
          <svg class="ml-1" stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <Button class="btn btn-outline-success"  onclick="alert('this')" >جfu</Button>
      
      <Nav style={{ marginLeft: "auto" }} dir="rtl">
         {this.getNavBar()}
         <form action="/search" class="form-inline my-2 my-lg-0">
           <input lang="fa" autocomplete="off" name="q" class="form-control mr-sm-2 ml-1" type="search" dir="rtl" placeholder="جستجو کنید!" aria-label="Search"></input>
           <button  lang="fa" class="btn btn-outline-success my-2 my-sm-0 ml-1" >جستجو</button>
         </form> 
         <button class="btn btn-outline-success my-2 my-sm-0 ml-1" href="/advancedsearch">جستجوی پیشرفته</button>
