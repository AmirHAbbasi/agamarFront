...
export default class ImageUpload extends React.Component {
    ...
    // onImageChange = event => {
    //     console.log("onImageChange function");
    ...
    handleUpload = event => {
        ...
        //     isBookStore: item.isBookStore,
        //     isPrivatePerson: item.isPrivatePerson
        // };
        // oldItem.prof_image = this.state.name === null ? "ye aksi" : this.state.name;
        // localStorage.setItem("info", JSON.stringify(oldItem));
